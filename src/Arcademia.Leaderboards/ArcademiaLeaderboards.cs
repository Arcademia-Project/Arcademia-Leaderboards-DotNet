    ...
    public static class ArcademiaLeaderboards
    {
        ...
        private static ArcademiaSettings LoadSettingsFile()
        {
            try
            {
                ...
                return JsonSerializer.Deserialize<ArcademiaSettings>(File.ReadAllText(path), JsonOptions);
            }
            catch (Exception ex)
            {
        ...
        public static async Task<PingResult> PingAsync()
        {
            ...
            try
            {
                if (_launcher != null)
                {
                    ...
                    var dto = JsonSerializer.Deserialize<LauncherResponseDto>(raw, JsonOptions);
                ...
                var ping = JsonSerializer.Deserialize<PingResponseDto>(response.Body, JsonOptions);
                return new PingResult
                {
                    Success = true,
                    Mode = ArcademiaMode.Sandbox,
            ...
            string boardSlug, string valueText, string playerName, string metadataJson, string scoreId)
        {
            ...
            var dto = JsonSerializer.Deserialize<SubmitResponseDto>(response.Body, JsonOptions);
            return new ScoreResult
            {
                Success = true,
                Status = "submitted",
            ...
            string boardSlug, int limit = 25, int offset = 0)
        {
            ...
            try
            {
                ...
                var dto = JsonSerializer.Deserialize<TestScoresDto>(response.Body, JsonOptions);
        ...
        public static async Task<ScoresResult> GetScoresAsync(string boardSlug, ScoreQuery query = null)
        {
            ...
            try
            {
                ...
                if (_launcher != null)
                {
                    ...
                    dto = JsonSerializer.Deserialize<ScoresDto>(raw, JsonOptions);
                ...
                else
                {
                    ...
                    dto = JsonSerializer.Deserialize<ScoresDto>(response.Body, JsonOptions);
                }
            ...
            string scoreId, Action<string> onClaimLink, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var created = JsonSerializer.Deserialize<SandboxClaimDto>(response.Body, JsonOptions);
                code = created.code;
                ...
                System.Diagnostics.Debug.WriteLine("[Arcademia] Open this link to claim the test score: " + claimUrl);
                ...
                while (true)
                {
                    ...
                    if (poll.IsSuccess)
                    {
                        var state = JsonSerializer.Deserialize<NameResponseDto>(poll.Body, JsonOptions);
        ...
        public static async Task<NameResult> SetPlayerNameAsync(string scoreId, string playerName)
        {
            ...
            try
            {
                ...
                var named = JsonSerializer.Deserialize<NameResponseDto>(response.Body, JsonOptions);
                return new NameResult
                {
                    Success = true,
                    Status = "saved",
